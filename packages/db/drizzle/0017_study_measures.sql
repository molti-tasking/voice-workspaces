...
--> statement-breakpoint
ALTER TABLE "agent_decision" ADD COLUMN "forced_answer" boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "study_response_phase_item_idx" ON "study_response" USING btree ("user_id","phase","item") WHERE "study_response"."capture_session_id" is null;--> statement-breakpoint
CREATE INDEX "study_response_user_at_idx" ON "study_response" USING btree ("user_id","responded_at");