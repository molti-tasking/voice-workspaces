...
const KNOWN_EVENTS = [
  ...
  "upload_drained",
  "upload_queue_reopened",
  "upload_session_reregistered",
  "user_signed_in",
  "user_signed_out",
  "user_signed_up",
  "wake_lock_denied",
...
describe("analytics taxonomy", () => {
  it("has not gained or lost an event without the list being updated", () => {
    ...
    const coverage: Record<AnalyticsEventName, true> = {
      board_brief_viewed: true,
      board_card_added: true,
      board_card_moved: true,
      board_card_retired: true,
      board_card_reworded: true,
      board_card_viewed: true,
      board_imported: true,
      board_viewed: true,
      ...
      upload_drained: true,
      upload_queue_reopened: true,
      upload_session_reregistered: true,
      user_signed_in: true,
